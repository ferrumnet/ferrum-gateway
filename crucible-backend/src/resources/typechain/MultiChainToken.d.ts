...
interface MultiChainTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintAndBurn(uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
    "name()": FunctionFragment;
    "owner()": FunctionFragment;
    "portal()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "setQuantumPortal(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setQuantumPortal",
    values: [string]
  ): string;
...
export class MultiChainToken extends BaseContract {
  ...
  callStatic: {
    ...
    setQuantumPortal(_qp: string, overrides?: CallOverrides): Promise<void>;
