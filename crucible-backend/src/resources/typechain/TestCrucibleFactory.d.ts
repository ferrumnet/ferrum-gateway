...
interface TestCrucibleFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "testName(address)": FunctionFragment;
    "testSymbol(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "testName", values: [string]): string;
  encodeFunctionData(functionFragment: "testSymbol", values: [string]): string;
  encodeFunctionData(
...
export class TestCrucibleFactory extends BaseContract {
  ...
  interface: TestCrucibleFactoryInterface;
  ...
  callStatic: {
    ...
    testName(token: string, overrides?: CallOverrides): Promise<string>;

    testSymbol(token: string, overrides?: CallOverrides): Promise<string>;
