...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "FestakedLib",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.FestakedLib__factory>;
    getContractFactory(
      name: "FestakedOptimized",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.FestakedOptimized__factory>;
    getContractFactory(
      name: "FestakedWithReward",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.FestakedWithReward__factory>;
    getContractFactory(
      name: "RewardAdder",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.RewardAdder__factory>;
    getContractFactory(
      name: "IFestaked",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.IFestaked__factory>;
    getContractFactory(
      name: "Admined",
      signerOrOptions?: ethers.Signer | FactoryOptions
