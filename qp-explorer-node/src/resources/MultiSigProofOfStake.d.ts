...
interface MultiSigProofOfStakeInterface extends ethers.utils.Interface {
  functions: {
...
export class MultiSigProofOfStake extends BaseContract {
  ...
  interface: MultiSigProofOfStakeInterface;
