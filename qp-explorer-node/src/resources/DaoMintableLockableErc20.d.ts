...
interface DaoMintableLockableErc20Interface extends ethers.utils.Interface {
  functions: {
    ...
    "daoAction(bytes32,bytes)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "daoAction", data: BytesLike): Result;
...
export class DaoMintableLockableErc20 extends BaseContract {
  ...
  interface: DaoMintableLockableErc20Interface;
