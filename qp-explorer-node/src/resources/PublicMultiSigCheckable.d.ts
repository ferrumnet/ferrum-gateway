...
interface PublicMultiSigCheckableInterface extends ethers.utils.Interface {
  functions: {
...
export class PublicMultiSigCheckable extends BaseContract {
  ...
  interface: PublicMultiSigCheckableInterface;
