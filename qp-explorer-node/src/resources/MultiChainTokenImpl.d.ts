...
interface MultiChainTokenImplInterface extends ethers.utils.Interface {
  functions: {
...
export class MultiChainTokenImpl extends BaseContract {
  ...
  interface: MultiChainTokenImplInterface;
