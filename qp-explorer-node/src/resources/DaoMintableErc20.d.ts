...
interface DaoMintableErc20Interface extends ethers.utils.Interface {
  functions: {
...
export class DaoMintableErc20 extends BaseContract {
  ...
  interface: DaoMintableErc20Interface;
