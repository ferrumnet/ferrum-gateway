...
interface HasTaxDistributorInterface extends ethers.utils.Interface {
  functions: {
...
export class HasTaxDistributor extends BaseContract {
  ...
  interface: HasTaxDistributorInterface;
