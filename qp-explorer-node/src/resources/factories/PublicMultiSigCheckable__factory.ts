...
import type {
  ...
  PublicMultiSigCheckableInterface,
} from "../PublicMultiSigCheckable";
...
export class PublicMultiSigCheckable__factory {
  static readonly abi = _abi;
  static createInterface(): PublicMultiSigCheckableInterface {
    return new utils.Interface(_abi) as PublicMultiSigCheckableInterface;
  }
  static connect(
    address: string,
