...
const getPreviousPendingTransactions = async() => {
    const key = "getPreviousPendingTransactions";
...
schedule.scheduleJob('1 * * * * *', async () => {
    ...
    const pendingTransactionList = await getPreviousPendingTransactions();
    ...
    web3ProvidersList.forEach(async (provider) => {
        ...
        const web3ProviderLogs = await web3.eth.getPastLogs({ fromBlock: 0, address: "0x89262b7bd8244b01fbce9e1610bf1d9f5d97c877" })
