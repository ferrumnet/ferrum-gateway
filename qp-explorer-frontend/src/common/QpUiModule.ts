...
import { QP_CONTRACT_CONFIG_MAINNET, QP_CONTRACT_CONFIG_TESTNET } from './Consts';
...
export class QpUiModule implements Module {
    ...
    async configAsync(c: Container): Promise<void> {
        ...
        try {
            ...
            c.registerSingleton(QpMinerClient, c => new QpMinerClient(c.get(StandaloneClient), c.get(StandaloneErc20),
                QP_CONTRACT_CONFIG_TESTNET, QP_CONTRACT_CONFIG_MAINNET));
