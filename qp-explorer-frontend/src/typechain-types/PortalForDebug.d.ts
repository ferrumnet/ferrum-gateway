...
interface PortalForDebugInterface extends ethers.utils.Interface {
  functions: {
    "VERSION()": FunctionFragment;
    "admin()": FunctionFragment;
    "callRemoteMethodForDebug(uint256,address,bytes,uint256)": FunctionFragment;
    ...
    "resetContextForDebug()": FunctionFragment;
    ...
    "setContextForDebug((uint64,(uint64,uint64,uint64),(uint64,address,address,address,address,uint256,bytes[],uint256,uint256),uint256))": FunctionFragment;
...
export class PortalForDebug extends BaseContract {
  ...
  callStatic: {
    ...
    resetContextForDebug(overrides?: CallOverrides): Promise<void>;
