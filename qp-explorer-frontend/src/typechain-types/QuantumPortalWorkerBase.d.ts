...
interface QuantumPortalWorkerBaseInterface extends ethers.utils.Interface {
  functions: {
    ...
    "updateMgr(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: "updateMgr", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "updateMgr", data: BytesLike): Result;
...
export class QuantumPortalWorkerBase extends BaseContract {
  ...
  interface: QuantumPortalWorkerBaseInterface;
  ...
  callStatic: {
    ...
    updateMgr(_mgr: string, overrides?: CallOverrides): Promise<void>;
  };
