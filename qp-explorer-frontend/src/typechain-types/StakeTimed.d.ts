...
interface StakeTimedInterface extends ethers.utils.Interface {
  functions: {
    ...
    "takeRewardsWithSignature(address,address,address,address[],bytes32,uint64,bytes)": FunctionFragment;
    "transferOwnership(address)": FunctionFragment;
    "usedHashes(bytes32)": FunctionFragment;
    "withdraw(address,address[],uint256)": FunctionFragment;
    "withdrawWithSignature(address,address,address,address,address[],uint256,bytes32,uint64,bytes)": FunctionFragment;
  };
