...
export type DeployedEvent = TypedEvent<[string] & { arg0: string }>;

export type DeployedWithDataEvent = TypedEvent<
  [string, string] & { conAddr: string; owner: string }
>;
...
export class FerrumDeployer extends BaseContract {
  ...
  filters: {
    ...
    "DeployedWithData(address,address)"(
      conAddr?: null,
      owner?: null
