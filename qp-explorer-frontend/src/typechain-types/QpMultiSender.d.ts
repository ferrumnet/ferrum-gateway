...
interface QpMultiSenderInterface extends ethers.utils.Interface {
  functions: {
    "admin()": FunctionFragment;
    "initializeWithQp(address)": FunctionFragment;
    "owner()": FunctionFragment;
    "portal()": FunctionFragment;
    "qpMultiSend(address[])": FunctionFragment;
...
export type LogEvent = TypedEvent<[string] & { msg: string }>;

export type OwnershipTransferredEvent = TypedEvent<
  [string, string] & { previousOwner: string; newOwner: string }
>;

export class QpMultiSender extends BaseContract {
  ...
  callStatic: {
    ...
    qpMultiSend(targets: string[], overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "Log(string)"(msg?: null): TypedEventFilter<[string], { msg: string }>;
