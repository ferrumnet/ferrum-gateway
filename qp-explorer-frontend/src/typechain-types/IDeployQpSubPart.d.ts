...
interface IDeployQpSubPartInterface extends ethers.utils.Interface {
  functions: {
...
export class IDeployQpSubPart extends BaseContract {
  ...
  interface: IDeployQpSubPartInterface;
